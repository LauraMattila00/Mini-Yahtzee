    ...
    return (
        <>
            ...
            <View style={styles.container}>
                <MaterialCommunityIcons name='information' size={90} color='darksalmon' style={styles.infologo} />
                {!hasPlayerName ?
                    <>
                        <Text style={styles.boldtext}>For scoreboard enter your name: </Text>
                        <TextInput onChangeText={setPlayerName}
                            autoFocus={true} style={styles.input}/>
                        <Pressable onPress={() => handlePlayerName(playerName)} style={styles.bluebutton}>
                            <Text style={styles.buttontext}>OK</Text>
                        </Pressable>
                    </>
                    :
                    <>
                        <Text style={styles.boldtext}>Rules of the game</Text>
                        ...
                        <Text style={styles.boldtext}>Good luck, {playerName}!</Text>
                        <Pressable style={styles.bluebutton} onPress={() => navigation.navigate('Gameboard', { player: playerName })} >
